...
<template>
  <div id='idx' class="container">
    <header class="header">
      ...
      <div class="swiper-container content-banner">
        <div class="swiper-wrapper">
          <div v-for="item in bannerList" class="swiper-slide" :key="item.id"><img class="img-h" :src="item" alt=""></div>
        </div>
    ...
    <div class="QQbox" id="divQQbox">
      <div id="divMenu">
        <a href="javascript:void(0)"><img class="img" src="./static/online.fw.png" alt=""></a>
        <a href="javascript:void(0)"><img class="img" src="./static/online2.fw.png" alt=""></a>
        <a href="javascript:void(0)"><img class="img" src="./static/online3.fw.png" alt=""></a>
        <a href="javascript:void(0)"><img class="img" src="./static/online4.fw.png" alt=""></a>
        <a id="goTop" href="#"><img class="img" src="./static/online5.fw.png" alt=""></a>
      </div>
    </div>
    <div class="content">
          ...
          <ul>
            <li class="horizontally ablout-item">
              ...
              <ul>
                ...
                <li class="about-content-item"> <router-link to="/about">公司简介</router-link></li>
                <li class="about-content-item"> <router-link to="/mission">品牌使命</router-link></li>
                <li class="about-content-item"> <router-link to="/history">发展历程</router-link></li>
                <li class="about-content-item"> <router-link to="/duty">企业责任</router-link></li>
                <li class="about-content-item"><router-link to="/honor">品牌荣誉</router-link></li>
              </ul>
            </li>
            <li class="horizontally ablout-item">
              <div class="about-content-title">
            ...
            <li class="horizontally ablout-item">
              ...
              <ul>
                <li class="about-content-item"><router-link to="/joinus">招商政策</router-link></li>
                <li class="about-content-item"><router-link to="/joinus">加盟流程</router-link></li>
                <li class="about-content-item"><router-link to="/joinus">申请加盟</router-link></li>
              </ul>
            </li>
